 ...
 *
 */
public class TreePrinter<E extends Comparable<? super E>> extends BinarySearchTree
{
    private static final int MAX_LEVELS = 6;
    
    private BinarySearchTree<E> tree;  // the tree
     ...
     */
    public TreePrinter(BinarySearchTree<E> tree)
    {
        this.tree = tree;
    ...
    {       
        ...
        thisLevelNodes[0] = tree.overallRoot;
